...
var piechart = new Chart(document.getElementById("twitterPiechart"), {
  type: "doughnut",
  data: {
...
var barchart = new Chart(document.getElementById("twitterBargraph"),{
    type: "bar",
    data:{
      labels: [bar_label1, bar_label2, bar_label3, bar_label4, bar_label5],
      datasets: [{
        data: [bar_count1,bar_count2,bar_count3, bar_count4, bar_count5],
